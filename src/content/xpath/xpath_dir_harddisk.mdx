...
```json
https://10.93.178.70/restconf/data/cisco-platform-software/q-filesystem=fru-rp,0,0,-1/partitions=harddisk:
```
...
```bash
curl -X 'GET' \
  'http://10.93.178.145:8480/restconf/proxy/https://10.93.178.70:443/restconf/data/Cisco-IOS-XE-platform-software-oper:cisco-platform-software/q-filesystem' \
