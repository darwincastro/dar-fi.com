...
description: This post is mainly focused in mapping VLANs using 2 Cisco Outdoors APs. The RAP will run Mobility Express WLC image, and the MAP is converted to CAPWAP mode.
tags: ["#wireless"]
category: Wireless
pubDate: Jul 15 2021
