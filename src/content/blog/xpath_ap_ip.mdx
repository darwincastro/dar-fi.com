...
```json
http://10.93.178.145:8480/restconf/proxy/https://10.93.178.68:443/restconf/data/Cisco-IOS-XE-wireless-access-point-oper:access-point-oper-data/capwap-data=00%3A04%3A05%3A00%3A02%3A00%20/ip-addr
```
...
```json
{
  "Cisco-IOS-XE-wireless-access-point-oper:ip-addr": "192.168.192.3"
}
```
